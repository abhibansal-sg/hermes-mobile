...
@pytest.mark.asyncio
async def test_drain_timeout_no_entry_sentinel_is_rejected_by_store_guard(monkeypatch):
...
@pytest.mark.asyncio
async def test_drain_timeout_marks_durable_pending_sentinel_sessions(monkeypatch):
