...
FIXED
- Self-heal a stalled dashboard event loop through the existing process supervisor (STR-12)
...
- Try: Leave the dashboard running through sustained gateway activity; it now records thread forensics and restarts if the event loop remains stalled for 75 seconds
