...
// Release-purity guard (task UI-G): the whole DebugBridgeTouch interface and
// implementation are compiled out of Release builds, so the binary carries no
// DebugBridgeTouch symbol. Xcode defines DEBUG=1 only in the Debug config.
#if DEBUG
