...
//
// One row per project in the overview list, scope-partitioned by
// (serverId, profileId) exactly
...
// the server's folded/worktree-hydrated project view, which is not
