...
def test_settings_attestation_fields(monkeypatch):
    ...
    monkeypatch.setenv("HERMES_RELAY_APPLE_APP_ID", "GCYB5LT4QQ.ai.hermes.app")
    s = Settings.from_env()
    assert s.require_attestation is True
    assert s.apple_app_id == "GCYB5LT4QQ.ai.hermes.app"
...
def _attest_app(tmp_path, verifier, max_per_key=5):
    ...
    settings = Settings(
        ...
        apple_app_id="GCYB5LT4QQ.ai.hermes.app",
