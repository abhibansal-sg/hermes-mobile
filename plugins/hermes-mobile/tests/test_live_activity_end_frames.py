...
def _assert_terminal_end_call(
    ...
    *,
    ...
    assert set(content_state) == expected_keys
...
def test_message_complete_emits_terminal_end_frame_through_live_activity_hook(
    ...
    def fake_notify(session_id, content_state, *, end=False, priority=None):
...
def test_startup_sweep_ends_tokens_for_dead_sessions_only(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(
        ...
        lambda session_id, content_state, *, end=False, priority=None: calls.append(
